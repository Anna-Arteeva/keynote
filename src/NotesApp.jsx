...
My journey into this started about 2 years ago.`,
  ...
  {
    cue: 'istorio screens',
    notes: `We picked a simple idea\u2014a language-learning app. I played the design process by the book. One month interviewing potential users, putting together a beautiful prototype in Figma. Testing, iterating. Then he spent another month building it. And after that we had this`,
  },
  {
...
Because I realised that my visually polished app offers **a learning experience of the past, not of the future**.`,
  ...
  {
    cue: 'Three changes that made this talk inevitable',
  ...
  {
    cue: 'It\u2019s not why I\u2019m here',
    notes: `It is not the story I came to Rotterdam to tell.`,
  },
  {
...
You tell it what you want in plain English. It does the research, creates a solution, fixes its own mistakes, and publishes the result.`,
  ...
  {
    cue: 'input A \u2192 output B',
    notes: `The system gave you the exact same predetermined response every time you took an action. Every single time. Input A equals output B. Systems were **deterministic**.`,
  },
  {
    cue: 'input A \u2192 output B, C, D',
    notes: `Today, even if you provide the exact same input, an AI might produce wildly different outputs. It is **non-deterministic**.
...
Traditional software design was like directing a scripted play. Every actor knew their lines. The lighting director knew exactly when to hit the spotlight. If someone forgot a line, that was a bug \u2014 you stopped the play to fix it.`,
  ...
  {
    cue: 'theatre',
    notes: `**Designing for AI is improvisational theatre.**
...
That variability is a feature. It's what makes AI AI.`,
  ...
  },
  {
    ...
    notes: `That means working in code \u2014 hooking your interface to a live AI model, shaping the system prompt, and designing through conversation with the system itself. **The design environment has to be as dynamic as the thing you're designing.**

But if the system doesn't follow a script anymore \u2014 why should the user?`,
  },
  {
    cue: 'From Commands to Outcomes',
  ...
  {
    cue: 'booking.com filters',
    notes: `Now you simply command it to your agent, and it books everything for you.`,
  },
  {
  ...
  {
    cue: 'supermarket / chef',
    notes: `The new model is a **restaurant**. A chef comes to your table, asks what you're craving, and brings you the finished meal.`,
  },
  {
    cue: 'Intent-based interaction',
    notes: `The interaction is now **intent-based**. You say what you want, the system figures out how.`,
  },
  {
...
The designer is designing an environment that helps users **articulate their intent** better.`,
  ...
  {
    cue: 'Help users overcome the blank box',
  ...
  {
    cue: 'Should we even be typing?',
    notes: `It reveals one truth about human communication: if typing our complex thoughts into a text box is really that difficult, maybe we shouldn't be typing at all.
...
The glasses read the Dutch words back into your ear \u2014 slowly, so you can repeat it to the waiter.`,
  ...
  {
    cue: 'Bitterballen quote',
    notes: `\u201cIk wil graag Bitterballen, alstublieft.\u201d
...
He still switches to English. Some things AI can't fix.`,
  ...
  {
    cue: 'voice-gesture-screen-vision',
    notes: `That pushes us beyond the text box entirely into the era of **multimodal, ambient interfaces**.`,
  },
  {
    cue: 'Multimodal UI',
  ...
  {
    cue: 'Whisper Flow',
    notes: `I talk to my computer all the time with Whisper Flow for dictation. The entire UI I interact with is an \u201cfn\u201d button on my keyboard. I press it, hear a soft chime, see a small bubble activate and start recording everything I ramble into a microphone, then convert it into clean, polished text. I get tremendous value from this product, and **the UI is basically invisible**.`,
  },
  {
    cue: 'minimal Whisper Flow UI, animated',
  ...
  {
    cue: 'When one modality fails, another takes over',
    notes: `The strongest interfaces are **hybrid**, they let modalities cover for each other. Voice fails in noise? Screen takes over. Display unreadable in sunlight? Audio narrates instead.`,
  },
  {
    cue: 'The screen isn\u2019t dying',
    notes: `The screen isn't dying. It's being **enhanced with new modes of interaction**.
...
If the system defines you as an action lover, the thumbnail shows an explosion. If it knows you prefer romance, the same movie appears with two actors making eye contact in pastel tones.`,
  },
  {
    ...
    notes: `That works because the **social contract is clear**. You know Netflix tracks your viewing habits, and you accept that trade-off.`,
  },
  {
    cue: 'Netflix works because the deal is clear',
    notes: `But once these memory systems move into email, calendars, and workspaces, **that contract starts to fray**.`,
  },
  {
    cue: 'But what about your email, your calendar, your Slack messages?',
    notes: `It's one thing for an AI to remember you like action films. It's another thing when your AI drafts an email to your boss in your exact tone of voice, referencing an inside joke from three weeks ago because it quietly read your Slack messages.`,
  },
  {
    cue: 'How do you design for personalisation',
    notes: `So how do you design for personalisation without eroding trust?`,
  },
  {
    cue: 'Memory is a design material',
    notes: `By treating **memory itself as a design material**.`,
  },
  {
    cue: 'Memory dashboard',
    notes: `For example, give users a **memory dashboard** \u2014 a visible, editable record of what the AI believes about them, something they can review, correct, and rewrite.`,
  },
  {
  ...
  {
    cue: 'Design tools leave too many dimensions undefined',
  ...
  {
    cue: '\u2026limiting our thinking to the purely visual',
    notes: `But it does not cut it anymore. Now our design toolbox should include live AI models, voice, vision, agents. And **the moment you can build with these materials, you start designing with them**.`,
  },
  {
    cue: 'The craft isn\u2019t pixels anymore. It\u2019s systems.',
  ...
  useEffect(() => {
    ...
    const onEnd = (e) => {
      ...
      if (Math.abs(dx) < 10 && Math.abs(dy) < 10 && dt < 300) {
        ...
        if (start.x > window.innerWidth * 0.5) go(current + 1)
        else go(current - 1)
      }
    }
